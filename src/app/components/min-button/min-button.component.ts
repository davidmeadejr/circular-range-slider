...
export class MinButtonComponent implements OnInit {
  /*
   * Creates an input decorator called diameterMinButton and assigns it a type number with a value of 200.
  ...
  /*
   * Creates an input decorator called minButtonCurrentPosition and assigns it a value of 220.
